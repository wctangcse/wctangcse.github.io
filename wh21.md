...
1. Download and install [IntelliJ IDEA](https://www.jetbrains.com/idea/), and an appropriate [JDK](https://www.oracle.com/uk/java/technologies/javase-downloads.html)
2. Download the [sample project](/files/java-robotwar.zip)
