...
- Preliminary games: participants will be randomly assigned in groups of 4 and play against each other in 10 games, for exactly 4 times in different random groups. The winner of each game is awarded 1 point (if draw, all players remain will be awarded 1 point). The eight participants with the highest points become the finalists.
